...
export default async function DashboardPage() {
  ...
  const departamento = ROLE_LABELS[role] ?? role
      ...
      <aside className="w-64 flex-shrink-0 flex flex-col border-r border-slate-200 bg-white">
        <div className="p-6 flex flex-col gap-6 h-full">
          ...
          <nav className="flex flex-col gap-1 grow">
            <a className="flex items-center gap-3 px-3 py-2 rounded-lg bg-blue-600 text-white" href="#">
              <span className="material-symbols-outlined text-[20px]">dashboard</span>
              <span className="text-sm font-medium">Dashboard</span>
            </a>
            <Link className="flex items-center gap-3 px-3 py-2 rounded-lg text-slate-600 hover:bg-slate-100 transition-colors" href="/solicitacoes">
        ...
        <header className="flex items-center justify-between border-b border-slate-200 bg-white px-8 py-4 sticky top-0 z-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="w-10 h-10 rounded-full bg-blue-600 border-2 border-blue-200 flex items-center justify-center text-white text-sm font-bold">
                {iniciais}
              </div>
            </div>
          </div>
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {solicitacoes.map(s => (
                      <tr key={s.id} className="hover:bg-slate-50 transition-colors">
                        <td className="px-6 py-4 text-sm font-medium text-slate-900">{s.nomeCompleto}</td>
